...
function SkeletonCard() {
  return (
    <div className="shrink-0 flex flex-col gap-2" style={{ width: 200 }}>
      <div className="bg-black/5 animate-pulse" style={{ width: 200, height: 112 }} />
      <div className="flex flex-col gap-1.5 px-0.5">
        <div className="h-2.5 bg-black/5 animate-pulse w-full" />
        <div className="h-2.5 bg-black/5 animate-pulse w-3/4" />
        <div className="h-2 bg-black/5 animate-pulse w-1/2 mt-0.5" />
      </div>
    </div>
  );
}
...
function VideoCard({ item }: { item: YoutubeItem }) {
  return (
    ...
    >
      <div className="relative overflow-hidden bg-black/5" style={{ width: 200, height: 112 }}>
      ...
      <div className="flex flex-col gap-0.5 px-0.5">
        ...
        <p className="text-[10px] text-black/30">{fmtDate(item.publishedAt)}</p>
      </div>
    </a>
  );
}
    ...
    <div className="mt-10">
      ...
      <div className="overflow-hidden border border-black/8">
        ...
        <div className="flex items-center gap-2 px-3 py-2 border-b border-black/8 bg-black/[0.02]">
          <button
            onClick={goHome}
            className="w-7 h-7 flex items-center justify-center hover:bg-black/8 transition-colors text-black/40 hover:text-black/70"
            style={{ borderRadius: 0 }}
            title="홈으로"
          >
          ...
          <div className="flex-1 mx-1 px-3 py-1 text-[11px] text-black/30 bg-black/5 truncate select-none">
